...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, default='/home/user9/ConDOR/data/Tau') 
    parser.add_argument('--data_min', type=float, default=0.005, help='minimum value of Tau')
    parser.add_argument('--data_max', type=float, default=9.2, help='maximum value of Tau')
    parser.add_argument('--age_min', type=float, default=48.0, help='minimum value of ADNI+Oasis Tau age')
    parser.add_argument('--age_max', type=float, default=88.2, help='maximum value of ADNI+Oasis Tau age')
