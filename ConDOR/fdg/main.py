...
if __name__ == '__main__':
    ...
    '''Cortical Thickness'''
    parser.add_argument('--dataset', type=str, default='FDG') 
    parser.add_argument('--alpha', type=float, default=0.1, help='weight of cohort-level noise, range: (0, 1)')
    parser.add_argument('--dir', type=str, default='/home/user9/Condor/data/FDG') 
    parser.add_argument('--data_min', type=float, default=0.003, help='minimum value of FDG')
    parser.add_argument('--data_max', type=float, default=2.004, help='maximum value of FDG')
    parser.add_argument('--age_min', type=float, default=56.2, help='minimum value of FDG age')
    parser.add_argument('--age_max', type=float, default=95.7, help='maximum value of FDG age')
    parser.add_argument('--test_num', type=int, default=136, help='number of test data')
